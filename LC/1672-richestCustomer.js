...
they have in all their bank accounts. The 
richest customer is the customer that has 
the maximum wealth.
...
Both customers are considered the richest with a 
wealth of 6 each, so return 6.
...
var maximumWealth = function (accounts) {
  ...
  for (let i = 0; i < accounts.length; i++) {
    let currWealth = accounts[i].reduce(reducer);
