...
the previous version, all the versions after a 
...
which returns whether version is bad. Implement a 
function to find the first bad version. You should
...
// brute force is to loop from 1 to N 
// and return once isBadVersion is true