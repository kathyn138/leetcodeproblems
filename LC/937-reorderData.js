...
Digit-logs: All words (except the identifier) consist 
of digits.
...
The digit-logs have a relative order of "dig1 8 1 5 1", 
"dig2 3 6".

Example 2:
Input: logs = ["a1 9 2 3 1","g1 act car","zo4 4 7",
...
* logs[i] is guaranteed to have an identifier and at least 
one word after the identifier.
*/
...
var reorderLogFiles = function (logs) {
  ...
  letterLogs.sort((a, b) => {
    ...
    // positive if a goes after b
    // negative if a goes before b
    // 0 if same
    if (compare > 0) {
      return compare;
    }
    // if 0, sort by identifiers 
