...
for those repeat numbers, k. For example, there won't be 
...
var decodeString = function (s) {
  ...
  for (let char of s) {
    ...
    // at this point curr is '['
    // after pop again, should be number or undefined
    let num = '';
    curr = stack.pop();


    while (!isNaN(Number(curr))) {
      // in case number has more than 1 digit
      num = curr + num;
      curr = stack.pop();
    }

    // in case there's a number after '['
    stack.push(curr);
