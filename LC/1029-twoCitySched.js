...
var twoCitySchedCost = (costs) => {
  ...
  let sum = 0;
  // sort by difference between the 2 cities
  // cityA - cityB
  // smallest difference goes first
  // with negative result, cityA costs less
  // with positive result, cityB costs less 
  // eg [259, 770] and [840, 118]

  costs.sort((a, b) => (a[0] - a[1] - (b[0] - b[1])));

  for (let i = 0; i < n; i++) {
    // instead of doing 2 for loops
